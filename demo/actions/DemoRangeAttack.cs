...
public partial class DemoRangeAttack : ActionRange
{
    ...
    public override IEnumerable<Vector2I> GetAllCellsInRange(UnitData unit, Vector2I cell) => unit.Grid.GetCellsInRange(cell, unit.Stats.AttackRange);
    ...
    public override IEnumerable<Vector2I> GetSources(UnitData unit, Vector2I target) => unit.Grid.GetCellsInRange(target, unit.Stats.AttackRange);
}