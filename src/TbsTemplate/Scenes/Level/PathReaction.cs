...
public partial class PathReaction : Reaction2<UnitRenderer, Godot.Collections.Array<Vector2I>>
{
    ...
    [Signal] public delegate void StateUpdatedEventHandler(UnitRenderer unit, Godot.Collections.Array<Vector2I> path);

    public PathReaction() : base(SignalName.StateUpdated) {}
    public new void React(UnitRenderer unit, Godot.Collections.Array<Vector2I> value) => base.React(unit, value);
}