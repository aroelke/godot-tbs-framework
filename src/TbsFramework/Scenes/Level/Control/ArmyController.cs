...
public abstract partial class ArmyController : Node
{
    ...
    [Signal] public delegate void UnitCommandedEventHandler(Vector2I cell, GenericUnitAction command);
    ...
    /// </param>
    public abstract void SelectUnit(GenericUnitAction[] actions);
    ...
    /// be used, but it's up to the implementor to determine what that priority is.
    /// </param>
    public abstract void MoveUnit(UnitData unit, GenericUnitAction[] actions);
    ...
    public abstract void CommandUnit(UnitData source, GenericUnitAction[] commands, GenericUnitAction cancel);
