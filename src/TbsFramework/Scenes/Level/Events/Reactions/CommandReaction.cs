...
public partial class CommandReaction : StateReaction2<Vector2I, GenericUnitAction>
{
    ...
    [Signal] public delegate void StateUpdatedEventHandler(Vector2I cell, GenericUnitAction command);

    public CommandReaction() : base(SignalName.StateUpdated) {}
    public new void React(Vector2I cell, GenericUnitAction command) => base.React(cell, command);
}